  ...
  <div class="flex h-max">
    ...
    <div class="w-1/2 bg-[#181818] flex-grow text-gray-300 flex flex-col p-8">
      ...
      <div>
        ...
        <button class="bg-[#1E40AF] text-white p-2 rounded hover:bg-[#1E3A8A] w-full mt-4" @click="fecthToken(email, password)">Login</button> <!-- Login button -->
      ...
      <div class="register-block">
        <p class="text-2xl mt-24 mb-4 flex-nowrap cursor-pointer" @click="toggleRegisterDialog">Click to register</p>
        <!-- Register button -->
...
const { fecthToken, registerUser, logout, name, email, password, user } = useUsers()
